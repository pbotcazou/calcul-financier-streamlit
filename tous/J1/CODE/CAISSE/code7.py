...
cols_to_check = ['temps_code5', 'nb_lignes_produits', 'nb_lignes_charges', 'nb_lignes_banque']

# Supprimer les lignes avec des -1 ou des 0
for col in cols_to_check:
    df = df[(df[col] != -1) & (df[col] != 0)]

# Conserver uniquement les colonnes utiles et supprimer les lignes NA
df_model = df[cols_to_check].dropna()
